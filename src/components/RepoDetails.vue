<script>
    ...
    methods: {
        fetchData: function () {
            this.loading = true
            fetch(`https://api.github.com/repos/OnshilAgassi8/${this.$route.params.id}`, {
            headers: {
            ...
            fetch(`https://api.github.com/repos/OnshilAgassi8/${this.$route.params.id}/branches`, {
                headers: {
                    Accept: "application/json"
                },
            })
            ...
            fetch(`https://api.github.com/repos/OnshilAgassi8/${this.$route.params.id}/deployments`, {
                headers: {
                    Accept: "application/json"
                },
            })
...
<template>
    <div id="repodetail">
        ...
        <div v-else class="repodetail-card">
            ...
            <p v-else>Live site: <a :href="`https://OnshilAgassi8.github.io/${details.name}`">OnshilAgassi8.github.io/{{ details.name }}</a></p>
